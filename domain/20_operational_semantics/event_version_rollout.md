...
- 非同期イベント/ジョブの進化を、
  producer / consumer の独立デプロイ下でも安全に行う。
- “なんとなく後方互換” を排除し、
  version 受理範囲と廃止期限を意味論として固定する。
...
### Breaking changes (not allowed in dual accept)
...
### Compatible changes (allowed in dual accept)
