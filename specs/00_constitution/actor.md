...
- delegation/impersonation は既存意味論へ後付け混入しない（導入は versioned）。
- cross-domain defaults（403/claims/trust boundary/global resource 等）は 00_constitution/global_defaults.md を参照する。
