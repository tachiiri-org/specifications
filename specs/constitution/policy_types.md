...
- authz PDP は adapter に固定（`constitution/authorization.md`）。
- 他 policy も PDP 位置を domain / boundary 契約で明示する（具体は L1 (tool-spec repos) / 運用意味論へ）。
...
- operational_semantics/cost_abuse_resource_exhaustion_protection.md
