...
- automation の executor は service actor として表現される（constitution/automation_human_boundary.md）。
...
- idempotency の最終 owner は adapter である（operational_semantics/idempotency.md）。
...
- constitution/automation_human_boundary.md
