...
- catalog metadata / audit shape / incident binding 等の具体キーや機械検査は、機械契約（schema/lint/contract）は L1 (tool-spec repos) で定義する。
...
- operational_semantics/operational_access_break_glass.md
